...
pub fn xlnx_fill_dec_params(dec_props: &mut Box<XlnxDecoderProperties>, dec_params: &mut Box<[XmaParameter; MAX_DEC_PARAMS]>) {
    dec_params[0].name = CString::new("bitdepth").unwrap().into_raw();
    ...
    dec_params[1].name = CString::new("codec_type").unwrap().into_raw();
    ...
    dec_params[2].name = CString::new("low_latency").unwrap().into_raw();
    ...
    dec_params[3].name = CString::new("entropy_buffers_count").unwrap().into_raw();
    ...
    dec_params[4].name = CString::new("zero_copy").unwrap().into_raw();
    ...
    dec_params[5].name = CString::new("profile").unwrap().into_raw();
    ...
    dec_params[6].name = CString::new("level").unwrap().into_raw();
    ...
    dec_params[7].name = CString::new("chroma_mode").unwrap().into_raw();
    ...
    dec_params[8].name = CString::new("scan_type").unwrap().into_raw();
    ...
    dec_params[9].name = CString::new("latency_logging").unwrap().into_raw();
    ...
    dec_params[10].name = CString::new("splitbuff_mode").unwrap().into_raw();
...
pub fn xlnx_create_dec_props(
    ...
    strcpy_to_arr_i8(&mut xma_dec_props.hwvendor_string, 256, "MPSoC")?;
