use crate::{strcpy_to_arr_i8, sys::*, xrm_precision_1000000_bitmask, xlnx_dec_utils::*, xlnx_scal_utils::*, xlnx_enc_utils::*};
...
pub fn xlnx_reserve_transcode_resource(
    ...
    xlnx_calc_transcode_load(xlnx_transcode_xrm_ctx, xma_dec_props, xma_scal_props, xma_enc_props, &mut transcode_cu_pool_prop)?;
    unsafe {
