...
static const ni_rational_t ni_h264_pixel_aspect_list[NI_NUM_PIXEL_ASPECT_RATIO]=
{
  {   0,  1 },
  {   1,  1 },
  {  12, 11 },
...
typedef enum _ni_h264_sei_type_t
{
  ...
  NI_H264_SEI_TYPE_USER_DATA_REGISTERED   = 4,   // registered user data as specified by Rec. ITU-T T.35
  NI_H264_SEI_TYPE_USER_DATA_UNREGISTERED = 5,   // unregistered user data
  NI_H264_SEI_TYPE_RECOVERY_POINT         = 6,   // recovery point (frame # to decoder sync)
  ...
  NI_H264_SEI_TYPE_MASTERING_DISPLAY_COLOUR_VOLUME = 137,  // mastering display properties
...
typedef enum _ni_h264_sei_pic_struct_t
{
  ...
  NI_H264_SEI_PIC_STRUCT_TOP_BOTTOM        = 3, //  3: top field, bottom field, in that order
  NI_H264_SEI_PIC_STRUCT_BOTTOM_TOP        = 4, //  4: bottom field, top field, in that order
  NI_H264_SEI_PIC_STRUCT_TOP_BOTTOM_TOP    = 5, //  5: top field, bottom field, top field repeated, in that order
  NI_H264_SEI_PIC_STRUCT_BOTTOM_TOP_BOTTOM = 6, //  6: bottom field, top field, bottom field repeated, in that order
...
typedef enum _ni_color_primaries
{
  ...
  NI_COL_PRI_BT709       = 1,  //< also ITU-R BT1361 / IEC 61966-2-4 / SMPTE RP177 Annex B
  NI_COL_PRI_UNSPECIFIED = 2,
  NI_COL_PRI_RESERVED    = 3,
  NI_COL_PRI_BT470M      = 4,  //< also FCC Title 47 Code of Federal Regulations 73.682 (a)(20)

  NI_COL_PRI_BT470BG     = 5,  //< also ITU-R BT601-6 625 / ITU-R BT1358 625 / ITU-R BT1700 625 PAL & SECAM
  NI_COL_PRI_SMPTE170M   = 6,  //< also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC
...
typedef enum _ni_color_transfer_characteristic
{
  ...
  NI_COL_TRC_GAMMA22      = 4,  //< also ITU-R BT470M / ITU-R BT1700 625 PAL & SECAM
  NI_COL_TRC_GAMMA28      = 5,  //< also ITU-R BT470BG
  NI_COL_TRC_SMPTE170M    = 6,  //< also ITU-R BT601-6 525 or 625 / ITU-R BT1358 525 or 625 / ITU-R BT1700 NTSC
  NI_COL_TRC_SMPTE240M    = 7,
  NI_COL_TRC_LINEAR       = 8,  //< "Linear transfer characteristics"
  NI_COL_TRC_LOG          = 9,  //< "Logarithmic transfer characteristic (100:1 range)"
  NI_COL_TRC_LOG_SQRT     = 10, //< "Logarithmic transfer characteristic (100 * Sqrt(10) : 1 range)"
  ...
  NI_COL_TRC_SMPTE2084    = 16, //< SMPTE ST 2084 for 10-, 12-, 14- and 16-bit systems
  ...
  NI_COL_TRC_ARIB_STD_B67 = 18, //< ARIB STD-B67, known as "Hybrid log-gamma"
...
{
  NI_COL_SPC_RGB         = 0,  //< order of coefficients is actually GBR, also IEC 61966-2-1 (sRGB)
  NI_COL_SPC_BT709       = 1,  //< also ITU-R BT1361 / IEC 61966-2-4 xvYCC709 / SMPTE RP177 Annex B
  NI_COL_SPC_UNSPECIFIED = 2,
  NI_COL_SPC_RESERVED    = 3,
  NI_COL_SPC_FCC         = 4,  //< FCC Title 47 Code of Federal Regulations 73.682 (a)(20)
  NI_COL_SPC_BT470BG     = 5,  //< also ITU-R BT601-6 625 / ITU-R BT1358 625 / ITU-R BT1700 625 PAL & SECAM / IEC 61966-2-4 xvYCC601
  NI_COL_SPC_SMPTE170M   = 6,  //< also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC
  NI_COL_SPC_SMPTE240M   = 7,  //< functionally identical to above
  NI_COL_SPC_YCGCO       = 8,  //< Used by Dirac / VC-2 and H.264 FRext, see ITU-T SG16
  ...
  NI_COL_SPC_CHROMA_DERIVED_NCL = 12, //< Chromaticity-derived non-constant luminance system
  NI_COL_SPC_CHROMA_DERIVED_CL = 13, //< Chromaticity-derived constant luminance system
 ...
 ******************************************************************************/
LIB_API int ni_logan_should_send_sei_with_frame(
