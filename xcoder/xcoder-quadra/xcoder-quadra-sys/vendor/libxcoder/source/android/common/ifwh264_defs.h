 ...
 */
#define DC_I16X16_MB_ROW                                                       \
    (DC_I16x16 << 24) | (DC_I16x16 << 16) | (DC_I16x16 << 8) | DC_I16x16
...
/*****************************************************************************/
#define MAX_PU_IN_MB ((MB_SIZE / MIN_PU_SIZE) * (MB_SIZE / MIN_PU_SIZE))

/* Number of max TU in a MB */
#define MAX_TU_IN_MB ((MB_SIZE / MIN_TU_SIZE) * (MB_SIZE / MIN_TU_SIZE))
...
#define MAX_4x4_SUBBLKS                                                        \
    (MAX_DC_4x4_SUBBLK_LUMA + MAX_DC_4x4_SUBBLK_CHROMA +                       \
...
#define TOTAL_SCALE_MAT_COUNT                                                  \
    (SCALE_MAT_CNT_TRANS_SIZE_4 + SCALE_MAT_CNT_TRANS_SIZE_8 +                 \
     SCALE_MAT_CNT_TRANS_SIZE_16 + SCALE_MAT_CNT_TRANS_SIZE_32)
